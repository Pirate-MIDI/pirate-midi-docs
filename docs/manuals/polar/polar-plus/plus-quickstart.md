...
![Polar Plus with ToneX One Context](../../../assets/PolarImages/polar-plus-v2-context1-square.jpg)

### Hardware Overview
* **Enclosure**: Can be opened over and over with metal threaded inserts and hex screws.

* **1.69" Screen**: Sharp and high quality LCD non-touch screen.

* **RGB LEDs**: One RGB LED per footswitch for signalling switch states.
...
* **Button Orientation**: With switch holes (front face) pointing towards you, **Bootloader=Left & Reset=Right**.
