...
Here is a sample of the onboard screens that are used to directly control parameters on the Polar Max. 

The controls encompass the effects and global parameter editing. The home screen shows amplifier images as well as a visual representation of connection status (Bluetooth, WiFi, USB), and the signal chain of effects.

Change presets by pressing the arrows left and right at the bottom of the screen.

The onboard memory can only hold either the amp skins or the pedal skins. Depending on which is more important to you, you can install different firmware versions following the firmware update instructions. 

![Polar Max Onboard Screen 1](../../../assets/PolarImages/screenshots/max-screens-1.jpg)

![Polar Max Onboard Screen 2](../../../assets/PolarImages/screenshots/max-screens%202.jpg)

![Polar Max Onboard Screen 3](../../../assets/PolarImages/screenshots/max-screens-3.jpg)

### Touchscreen Sensitivity

If you apply the protective screen overlay and find that the touchscreen is less responsive, enter the web config and change the sensitivity option to "high" to fix it. 
