...
You will be prompted to press the bootloader button while powering on the device. On the Polar Max v2, the bootloader button is accessed through a small hole in the side of the enclosure. The bootloader button is inside the hole closest to the front edge of the enclosure. 
